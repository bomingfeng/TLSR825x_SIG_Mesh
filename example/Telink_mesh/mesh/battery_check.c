...
//////////////// adc sample data convert to voltage(mv) ////////////////
	...
	u8	tbl_advData[4+ADC_SAMPLE_NUM*2 ] = {0}; //Adv Packet, 
...
{
    #if __PROJECT_BOOTLOADER__ /*安信可不使用*/
    sleep_us(50*1000);
	...
	#else
    cpu_sleep_wakeup(DEEPSLEEP_MODE, PM_WAKEUP_TIMER, clock_time() + 50*CLOCK_SYS_CLOCK_1MS);  /* clock_time() 相当于读定时器值*/
    #endif
    #endif
}
